      ...
      markLine: {
        ...
        data: [
          ...
          },
          {
            ...
            yAxis: data["{{ ticker.code }}"].values[data["{{ ticker.code }}"].values.length - 1][1]
          },
          {
            name: "loss cut line",
            yAxis: data["{{ ticker.code }}"].values[data["{{ ticker.code }}"].values.length - 1][1] * 0.92
          },
          {
            name: "profit fix line",
            yAxis: data["{{ ticker.code }}"].values[data["{{ ticker.code }}"].values.length - 1][1] * 1.2
          },
        ]
      },
      markPoint: {
        data: [
          {% for point in ticker.mark_points %}
          {
