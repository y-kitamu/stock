...
# def run_all(codes: list[str] = [], output_dir: Path = stock.DATA_DIR / "financials") -> tuple[list[str], list[str]]:
...
#                 stock.logger.info(f"Skip {code}")
#                 continue
#             try:
#                 run(driver, code, output_dir)
#                 success_list.append(code)
#             except Exception as e:
#                 stock.logger.warning(f"Failed to collect financial data of {code}: {e}")
